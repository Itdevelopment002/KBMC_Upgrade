...
router.get("/health_photo_gallery", (req, res) => {const language = req.query.lang;
  let query;
  let params = [];
  if (language) {
    query = `SELECT * FROM health_photo_gallery WHERE language_code = ?`;
    params.push(language);
  } else {
    query = "SELECT * FROM health_photo_gallery";
  }
